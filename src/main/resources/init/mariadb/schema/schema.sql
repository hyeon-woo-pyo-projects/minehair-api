...
CREATE TABLE IF NOT EXISTS coupon_issue (
    ...
    issue_date DATE NOT NULL COMMENT '발급 일자',
    ...
    updated_id BIGINT NOT NULL COMMENT '수정자 ID',
    updated_at DATETIME NULL COMMENT '수정 시간'
) COMMENT '쿠폰 발급 테이블' CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS logo (
    ...
    description TEXT NULL COMMENT '로고 내용',
    image_url TEXT NOT NULL COMMENT '이미지 URL',
    status VARCHAR(20) NOT NULL DEFAULT 'active' COMMENT '상태',
    created_id BIGINT NOT NULL COMMENT '생성자 ID',
    created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '생성 시간',
    updated_id BIGINT NOT NULL COMMENT '수정자 ID',
    updated_at DATETIME NULL COMMENT '수정 시간'
) COMMENT '로고 테이블' CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS board_review_category (
    ...
    updated_id BIGINT NOT NULL COMMENT '수정자 ID',
    updated_at DATETIME NULL COMMENT '수정 시간'
) COMMENT 'Review 카테고리 테이블' CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS board_review_reply (
    ...
    updated_id BIGINT NOT NULL COMMENT '수정자 ID',
    updated_at DATETIME NULL COMMENT '수정 시간'
) COMMENT 'Review 댓글 테이블' CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS map_address (
    ...
    updated_id BIGINT NOT NULL COMMENT '수정자 ID',
    updated_at DATETIME NULL COMMENT '수정 시간'
) COMMENT '지도 주소 테이블' CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;